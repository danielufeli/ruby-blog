...
RSpec.describe 'comments API' do
  ...
  describe 'POST /posts/:post_id/comments' do
    let(:valid_attributes) { { name: 'Daniel Ufeli', comment: 'I love Africa' } }
    ...
    context 'when an invalid request' do
      ...
      it 'returns a failure message' do
        expect(response.body).to match(/Validation failed: Name can't be blank, Comment can't be blank/)
      end
    end
  end
